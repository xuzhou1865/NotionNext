...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://fanatical-cod-458.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '317ef7e2fe0481b1bd2cdc89a8371226', // '02ab3b8678004aa69e9e415905ef32a5,en:7c1d570661754c8fbc568e00a01fd70e', by xuzhou 使用自己的notionID
  THEME: process.env.NEXT_PUBLIC_THEME || 'xuzhou', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
