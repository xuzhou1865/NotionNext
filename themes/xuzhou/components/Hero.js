              ...
              <div className='hero-content wow fadeInUp mx-auto max-w-4xl text-center' data-wow-delay='0.5s'>
                ...
                <div className='max-w-2xl mx-auto bg-gray-900 rounded-xl p-8 shadow-lg'>
                  <div className='text-center'>
                    <div className='mb-4'>
                      <span className='inline-block px-4 py-1 bg-gray-800 text-gray-300 text-sm font-medium rounded-full'>
                        ⭐ 小报童专栏
                      </span>
                    </div>
                    ...
                    <SmartLink
                      ...
                      className='inline-flex items-center justify-center rounded-lg bg-white text-gray-900 px-8 py-4 text-center text-lg font-bold transition duration-300 ease-in-out hover:bg-gray-100 shadow-lg hover:shadow-xl transform hover:-translate-y-1'>
                      前往订阅 →
                    </SmartLink>
                  </div>
                </div>
